...
export default function HomePage() {
  ...
  const [stats, setStats] = useState([
    { label: "Smart Contracts Deployed", value: "24", icon: <NetworkEthereum size={24} variant="branded" />, theme: "blockchain" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="mb-6 sm:mb-8">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 justify-center">
              <Link 
                href="/admin" 
                className="web3-gradient-button text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 web3-button-stable web3-subtle-glow min-h-[44px] flex items-center justify-center"
              >
              ...
              <Link 
                href="/cooperatives" 
                className="web3-button-outline text-base sm:text-lg px-6 sm:px-8 py-3 sm:py-4 web3-holographic-border web3-button-stable min-h-[44px] flex items-center justify-center"
              >
