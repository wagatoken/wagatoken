...
import { MdAdminPanelSettings, MdCoffee, MdLocalShipping, MdStorefront, MdLocalFireDepartment } from 'react-icons/md';
                    ...
                    <div className="p-2">
                      ...
                      {portalItems.map((portal) => (
                        <Link
                          ...
                          className={`flex items-center gap-2 block px-3 py-2 rounded-md text-sm transition-all duration-200 ${
              ...
              <div className="py-2">
                ...
                {portalItems.map((portal) => (
                  <Link
                    key={portal.href}
                    href={portal.href}
                    className={`web3-touch-target flex items-center gap-2 justify-start px-3 py-3 rounded-lg text-sm font-medium transition-all duration-300 sm:text-base ${
                      pathname.startsWith(portal.href)
